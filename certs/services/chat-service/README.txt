Certificate Package: chat-service
Generated: 2026-06-03 15:05 UTC
Valid for: 365 days
CA: TranscendenceCA

FILES
─────
chat-service.key          RSA private key      — DO NOT DISTRIBUTE (chmod 600)
chat-service.crt          Signed certificate   — safe to distribute
chat-service.pem          key + cert bundle    — nginx, HAProxy, raw TLS (chmod 600)
chat-service-chain.pem    cert + CA bundle     — give to clients for mutual TLS trust
chat-service.p12          PKCS12 keystore      — Spring Boot server.ssl.*
